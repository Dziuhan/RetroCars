					...
					<c:forEach items="${orders}" var="order">
						<tr>
							...
							<td><form action="ManagerController" method="post">
									<input type="number" name="priceCrush" required="required"
										placeholder="price"> <input type="hidden"
										name="commandManager" value="crushCarOrder"> <input
										type="hidden" name="idOrderManager" value="${order.id}">
									<input type="submit" value="Crush car">
								</form></td>

							<td><form action="ManagerController" method="post">
									<input type="hidden" name="commandManager" value="closeOrder">
